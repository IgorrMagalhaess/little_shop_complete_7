...
describe "Admin Invoices Index Page" do
  before :each do
    ...
    @d1 = BulkDiscount.create!(quantity: 10, percentage: 10, merchant_id: @m1.id)
  ...
  it "should display the total revenue with discounts the invoice will generate" do
    expect(page).to have_content("Total Revenue after Discounts: $#{@i1.total_revenue_with_discount}0")
